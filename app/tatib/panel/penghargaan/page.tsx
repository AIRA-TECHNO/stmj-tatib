        ...
        <div className="card">
          <div className='card-body py-4'>
            <Table
              ...
              prototypeTable={[
                {
                  label: "nama", classNameTd: 'px-1', name: (data) => {
                    ...
                    return (
                      <div className='max-w-[calc(100vw-3rem)] [&>*]:truncate'>
                        ...
                        <div className='mt-2 text-sm'>{data.achievement} <span className='text-success text-xs font-semibold'>{`(${data?.point})`}</span></div>
