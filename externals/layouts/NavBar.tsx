...
export default function NavBar({ forcedShow }: {
  ...
  return (
    <>
      ...
      >
        <div className={'flex items-center h-[3.5rem] sm:h-[5rem] max-w-9xl mx-auto sm:px-6'}>
          ...
          <div className='hidden lg:flex items-center ml-auto '>
            <div className='flex items-center gap-4'>
              ...
              <div>
                <div className='font-semibold text-lg'>SMKN 1 JENANGAN</div>
                <div className='text-sm font-bold tracking-[0.25rem] text-secondary'>STMJ UNGGUL</div>
              </div>
            </div>
          </div>
        </div>
